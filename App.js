...
function App() {
  ...
  const frameProcessor = useFrameProcessor(frame => {
    ...
    const poseCopy = {
      ...
      leftElbow: {x: 0, y: 0,z:0,visibility:0},
      rightElbow: {x: 0, y: 0,z:0,visibility:0},
      leftWrist: {x: 0, y: 0,z:0,visibility:0},
      rightWrist: {x: 0, y: 0,z:0,visibility:0},
      leftHip: {x: 0, y: 0,z:0,visibility:0},
      rightHip: {x: 0, y: 0,z:0,visibility:0},
      leftKnee: {x: 0, y: 0,z:0,visibility:0},
      rightKnee: {x: 0, y: 0,z:0,visibility:0},
      leftAnkle: {x: 0, y: 0,z:0,visibility:0},
      rightAnkle: {x: 0, y: 0,z:0,visibility:0},
    };

    console.log('POSE VALUE',JSON.stringify(poseObject, null, 2))
